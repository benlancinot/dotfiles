...
(custom-set-variables
 ...
 '(package-selected-packages
   '(string-inflection cl-lib org-superstar centaur-tabs tabbar yasnippet yaml-mode ws-butler web-mode use-package undo-tree terraform-mode smex protobuf-mode paradox neotree multiple-cursors magit-section js2-mode ivy-prescient go-add-tags git-commit ggtags flymd exec-path-from-shell dtrt-indent doom-themes dashboard dash-functional counsel-projectile company-go comment-dwim-2 clean-aindent-mode autothemer all-the-icons-ivy-rich all-the-icons-ivy all-the-icons-dired ace-window))
